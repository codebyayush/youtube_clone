...
const Header = () => {
  ...
  return (
    <>
    <div className={`flex w-full z-20 transition-all duration-300 ${isVisible && "pl-52 screen-max-7:pl-0"} fixed border-b justify-between bg-white px-6 py-3  screen-max-7:flex-col screen-max-7:items-center screen-max-7:gap-5`}>
        {/* icon and hamburger */}
